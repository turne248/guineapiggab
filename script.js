...
let mobilesupportHTML = '<div class="sidebar-title" style="padding-left: 20px;"><img class="section-heading" src="' + relativePath + '/images/support.gif"></div> <div class="support-container"> <div class="meena-holder" style="width: 60%; margin-right: 10px; margin-bottom: -3px;"> <a href="https://ko-fi.com/guineapiggab"><img src="' + relativePath + '/images/oz-head.png"></a> </div> <div style="align-content: center;"> <a href="https://ko-fi.com/guineapiggab"><img src="' + relativePath + '/images/piggy-bank.gif" style="filter: saturate(4);"></a> </div> </div> <div class="support-description"> <p>All proceeds go towards future vet bills</p></div>';
...
let mobileguesswidgetHTML = '<div class="nose-container"> <img class="mystery-img" src="' + relativePath + '/images/cheryl-nose.jpg"> </div> <p class="piggy-name hidden-name" style="margin:0;">???</p><button class="reveal-btn" onclick="revealAnswer()">Reveal</button>';
...
let footerHTML = "<div class='footer-container'><div><a class='footer-links' href='https://github.com/turne248/'>Github</a><a class='footer-links' href='https://ko-fi.com/guineapiggab'>Piggy Bank</a><a class='footer-links' href='robby-turner.com'>See My Work</a><a class='footer-links' href='https:www.instagram.com/itsrober_?'>IG</a></div><div><p style='color: #efefef;'>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>.</p><hr></div><div class='viewer-counter'><a href='http://www.snazzyspace.com/generators/viewer-counter/' title='SnazzySpace.com Viewer Counter' target='_blank'><img src='http://www.snazzyspace.com/generators/viewer-counter/counter.php/fid=1789433426/style=5/counter.png' border='0'></a></div>";
