...
'<li><a href="' + relativePath + '/about.html" class="menu-item">About</a></li>' +
...
let statusHTML = '<div class="sidebar-title"><img class="section-heading" src="' + relativePath + '/images/current-status.gif" style="height: 27px; padding-left: 20px;"></div><<div id="statuscafe"><div id="gpgadmin"></div><div id="statuscafe-content"></div></div>';
let mobilestatusHTML = '<div class="sidebar-title"><img class="section-heading" src="' + relativePath + '/images/current-status.gif" style="height: 27px; padding-left: 20px;"></div><blockquote style="margin: 0em 0;"></blockquote>';
...
let counterHTML = '<div class="sidebar-title" style="padding-left:20px;"><img class="section-heading" src="' + relativePath + '/images/bean-counter.gif"></div> <div class="bean-holder"><div class="meena-holder"><img src="' + relativePath + '/images/bean.png" style="margin: 5px auto;"></div></div><div><div class="counter-display"><span class="count-number">000000</span></div><button id="increment-btn" onclick="incrementGlobalCounter()">+ Click</button></div>';
let mobilecounterHTML = '<div class="sidebar-title" style="padding-left:10px;"><img class="section-heading" src="' + relativePath + '/images/bean-counter.gif"></div> <div class="bean-holder"><div class="meena-holder"><img src="' + relativePath + '/images/bean.png" style="margin: 5px auto; display: block"></div></div><div><div class="counter-display"><span class="count-number">000000</span></div><button id="increment-btn" onclick="incrementGlobalCounter()">+ Click</button></div>';

let supportHTML = '<div class="sidebar-title" style="padding-left:20px;"><img class="section-heading" src="' + relativePath + '/images/support.gif"></div> <div class="support-container"> <div class="meena-holder" style="width: 180%; margin-right: 10px; margin-bottom: -3px;"> <a href="https://ko-fi.com/guineapiggab"><img src="' + relativePath + '/images/oz-head.png"></a> </div> <div style="align-content: center;"> <a href="https://ko-fi.com/guineapiggab"><img src="' + relativePath + '/images/piggy-bank.gif" style="filter: saturate(4);"></a> </div> </div> <div class="status-text"> <div class="support-description"> <p>Want to support GPG? Donations are 100% optional and 100% appreciated!</p> </div></div>';
let mobilesupportHTML = '<div class="sidebar-title" style="padding-left: 20px;"><img class="section-heading" src="' + relativePath + '/images/support.gif"></div> <div class="support-container"> <div class="meena-holder" style="width: 60%; margin-right: 10px; margin-bottom: -3px;"> <a href="https://ko-fi.com/guineapiggab"><img src="' + relativePath + '/images/oz-head.png"></a> </div> <div style="align-content: center;"> <a href="https://ko-fi.com/guineapiggab"><img src="' + relativePath + '/images/piggy-bank.gif" style="filter: saturate(4);"></a> </div> </div> <div class="status-text"> <div class="support-description"> <p>Want to support GPG? Donations are 100% optional and 100% appreciated!</p></div></div';
...
let mobileguesswidgetHTML = '<div class="nose-container"> <img class="mystery-img" style="margin: 0;" src="' + relativePath + '/images/cheryl-nose.jpg"> </div> <p class="piggy-name hidden-name" style="margin:0;">???</p><button class="reveal-btn" onclick="revealAnswer()">Reveal</button>';
let guesswidgetHTML = '<div class="nose-container"> <img class="mystery-img" style="margin: 0;" src="' + relativePath + '/images/cheryl-nose.jpg"> </div> <p class="piggy-name hidden-name" style="margin:0;">???</p><button class="reveal-btn" onclick="revealAnswer()">Reveal</button>';
  ...
  fetch(`https://status.cafe/users/${username}/status.json`)
    ...
    .then(data => {
      const statusHTML = data.content
        ...
        <img class="section-heading" src="${relativePath}/images/current-status.gif" style="height: 27px; padding-left: 10px;">
        </div>
...
const PET_LIBRARY = [
  ...
  { name: 'Scooter',  idle: `${relativePath}/images/scooter.png`,  happy: `${relativePath}/images/scooter-excited.png` },
  { name: 'Sage', idle: `${relativePath}/images/sage.png`, happy: `${relativePath}/images/sage-excited.png` },
  { name: 'Cheryl', idle: `${relativePath}/images/cheryl.png`, happy: `${relativePath}/images/cheryl-excited.gif` }
];
...
const GUESSING_GAME_LIBRARY = [
  ...
  { 
    name: "Scooter!", 
    image: `${relativePath}/images/scooter-nose.jpg`, 
    focus: "70% 70%", 
  ...
  { 
    name: "Sage!", 
    image: `${relativePath}/images/sage-nose.jpg`, 
    focus: "45% 30%", 
  ...
  { 
    name: "Cheryl!", 
    image: `${relativePath}/images/cheryl-nose.jpg`, 
    focus: "45% 30%", 
    transformOrigin: "center",
    zoomLevel: "400%" 
  },
  { 
    name: "Oz!", 
    image: `${relativePath}/images/oz-nose.jpg`, 
    focus: "left 80%",
...
const PHOTO_FOLDER = `${relativePath}/images/potd/`;
